...
export const FaceMatchDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="faceMatchDeleteDialogHeading">
        Confirm delete operation
      </ModalHeader>
      <ModalBody id="kycsupportApp.faceMatch.delete.question">Are you sure you want to delete Face Match {faceMatchEntity.id}?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-faceMatch" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
