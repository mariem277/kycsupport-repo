...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGULATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REGULATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REGULATION actions', async () => {
      const arg = { id: 27428 };
    ...
    it('dispatches UPDATE_REGULATION actions', async () => {
      const arg = { id: 27428 };
    ...
    it('dispatches PARTIAL_UPDATE_REGULATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REGULATION actions', async () => {
      const arg = 42666;
