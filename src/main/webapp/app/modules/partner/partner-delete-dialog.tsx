...
export const PartnerDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/partner${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kycsupportApp.partner.delete.question">Are you sure you want to delete Partner {partnerEntity.id}?</ModalBody>
      <ModalFooter>
