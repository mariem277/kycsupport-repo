...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACEMATCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FACEMATCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FACEMATCH actions', async () => {
      const arg = { id: 31948 };
    ...
    it('dispatches UPDATE_FACEMATCH actions', async () => {
      const arg = { id: 31948 };
    ...
    it('dispatches PARTIAL_UPDATE_FACEMATCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FACEMATCH actions', async () => {
      const arg = 42666;
